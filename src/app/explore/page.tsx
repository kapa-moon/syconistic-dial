...
const STORAGE_KEY = "syconistic-explore-chats"
          ...
          <div className="flex-1 overflow-y-auto px-6 py-6 space-y-8">
            {turns.length === 0 && !isLoading && (
              <div className="flex items-center justify-center h-full">
                <p className="text-sm text-zinc-400">Send a message to see all 5 response styles side by side…</p>
              </div>
            )}
          ...
          <div className="px-6 py-4 bg-white border-t border-zinc-200">
            <div className="flex gap-2">
              <textarea
                ...
                placeholder="Type a message to see all 5 sycophancy levels simultaneously…"
                rows={2}
                value={input}
